                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_uz" class="form-control" name="title_uz" placeholder="Sarlavha (UZ)" value="{{ old('title_uz', $banner->title_uz) }}">
                                @error('title_uz')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru" placeholder="Sarlavha (RU)" value="{{ old('title_ru', $banner->title_ru) }}">
                                @error('title_ru')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_en" class="form-control" name="title_en" placeholder="Sarlavha (EN)" value="{{ old('title_en', $banner->title_en) }}">
                                @error('title_en')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                                <img id="photo_preview" src="{{ asset('storage/' . $banner->photo) }}" style="max-width: 100%; margin-top: 10px;" />
                            </div>
                        </div>
                    </div>
