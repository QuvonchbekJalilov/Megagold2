                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_uz" class="form-control" name="title_uz" placeholder="Sarlavha uz" value="{{ old('title_uz', $item->title_uz) }}">
                                @error('title_uz')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru" placeholder="Sarlavha ru" value="{{ old('title_ru', $item->title_ru) }}">
                                @error('title_ru')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_en" class="form-control" name="title_en" placeholder="Sarlavha en" value="{{ old('title_en', $item->title_en) }}">
                                @error('title_en')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="short_content_uz" class="form-control" name="short_content_uz" placeholder="Tavsif uz" value="{{ old('short_content_uz', $item->short_content_uz) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="short_content_ru" class="form-control" name="short_content_ru" placeholder="Tavsif ru" value="{{ old('short_content_ru', $item->short_content_ru) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="short_content_en" class="form-control" name="short_content_en" placeholder="Tavsif en" value="{{ old('short_content_en', $item->short_content_en) }}">
