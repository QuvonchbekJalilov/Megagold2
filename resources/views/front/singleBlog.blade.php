            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="comment_form mb-120">
                        <h3 class="title_comments">{{__('words.contact')}}</h3>
                        <form action="javascript:sendComment();">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="wrap-form">
                                        <input type="text" id="phone_number" placeholder="your phone_number" value="+998">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="wrap-form">
                                        <textarea cols="74" id="message" rows="8" placeholder="write message *"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <button type="submit" class="cmn_btn rd-remove">{{__('words.send')}}<i class="far fa-long-arrow-right"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    function sendComment() {
        ...
        const telegramMessage = `Habar qabul qilindi:\n\nIsm: ${name}\nTelefon Raqam: ${phone_number}\nXabar: ${message}`;
        const telegramBotToken = '7217681658:AAGzxilWkKBQqgxsA9Nte_T3viv4I7c2TkY'; // Replace with your bot token
        const telegramChatId = '-4236704302'; // Replace with your chat ID
        ...
        .then(data => {
            if (data.ok) {
                ...
                document.getElementById('phone_number').value = '+998';
