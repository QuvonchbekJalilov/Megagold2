                                ...
                                <table class="table table-striped table-bordered tbl-shopping-cart">
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-name"><a href="shop-product-details.html">Winter Black
                                                    Jacket</a>
                                                <ul class="variation">
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-name"><a href="shop-product-details.html">Swan Crop
                                                    V-Neck Tee</a>
                                                <ul class="variation">
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-name"><a href="shop-product-details.html">Blue Solid
                                                    Casual Shirt</a>
                                                <ul class="variation">
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td colspan="2">&nbsp;</td>
                                            <td><button type="button" class="theme-btn btn-style-one"><i
                                                        class="icon fa fas fa-plus"></i> <span class="btn-title">Update
                                                        Cart</span></button></td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="col-md-12 mt-30">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <a class="theme-btn btn-style-one" href="shop-checkout.html"><i
                                            class="icon fa fas fa-plus"></i> <span class="btn-title">Proceed to
                                            Checkout</span> </a>
                                </div>
                            </div>
                        </div>
