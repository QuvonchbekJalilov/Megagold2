                    ...
                    <div class="row">
                        <div class="footer-column col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="footer-widget about-widget">
                                <div class="logo"><a href="{{route('index')}}"><img src="/assets/images/logo-dark.png" alt=""></a></div>
                                <ul class="contact-info">
                                    <li><i class="fa fa-map-marker-alt"></i>Uzbekistan, Tashkent Bunyodkor </li>
                                    <li><i class="fa fa-envelope"></i> <a
                                            href="mailto:info@megagold.uz"><span
                                                class="__cf_email__"
                                                data-cfemail="1e6d6b6e6e716c6a6d5e7c6b6d77737f66307d7173">info@megagold.uz</span></a>
                                    </li>
                        ...
                        <div class="footer-column col-xl-2 offset-xl-1 col-lg-3 col-md-6 col-sm-6">
